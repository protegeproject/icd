...
public class Interface2 {//not used
	...
	public static String createMultipleQuestion(String disease,
		...
		try {
			...
			String xml = "<QuestionForm xmlns='http://mechanicalturk.amazonaws.com/AWSMechanicalTurkDataSchemas/2005-10-01/QuestionForm.xsd'>"
					...
					+ "</Text>"
					+ "<FormattedContent><![CDATA["
					+ "<p>This is the Wikipedia Page for "
					+ "<a href='"
					+ wiki
					+ "' target='_blank'>"
					+ disease
	...
	public static void approveAssignments() {
		...
		try {
			...
			HITIDs.add("2WT0HFL42J1LVV8YETYMAIGFLFC1MU");
			HITIDs.add("218W618N46UXC2DRCO3E3NDSORIQOS");
			HITIDs.add("2A3B3L0FBJ9IL1J1QI5VO5RPS0LMYD");
			HITIDs.add("2SOBFMFFOYYIQRT6M47E2C0RYUPMZ4");
			HITIDs.add("21E4ZMAZHHRRI5QNVEEV1H1KIM8KBR");
			HITIDs.add("292MT6YTWX4H072CIV49JGI6JHPW1F");
			HITIDs.add("26UGJ2D21O3W2NHNQGGSS2KYFNJD7K");
			HITIDs.add("2BLK4F0OHOVRYUIKRFTLJ2HEDVF325");
			HITIDs.add("283PHIT3HVWASAIT9EAQC17208DKC5");
			HITIDs.add("2M998D8J3VE7TISGUP3GDMCK99XXHG");
			HITIDs.add("2CIFK0COK2JEYC7CRB0L1W6O08BKR4");
			HITIDs.add("2A4OFXRDS4ICY4Y0UOAFW11A3HZXUH");
			HITIDs.add("2EXB0HFL42J1IO5VIYT7W0IGGJM0LW");
			HITIDs.add("218W618N46UXC2DRCO3E3NDSOSPOQZ");

			HITIDs.add("2YVM25L8I9NZTWH16XFEEQW7U7ASIW");
			HITIDs.add("25UCF0CP5KXPQ8N5POPGEPM7OXAXWG");
			HITIDs.add("2P4Z9O9Z6KW4WCAMO8IRVFQ0PMS3CE");
			HITIDs.add("2Y9RLFQ0ONNVO717OF0EQRB77MZSJ8");
			HITIDs.add("2ECYT3DHJHP483D7NVP81SX9Y2LU1N");
			HITIDs.add("2T5HMVHVKCJ0YRKPEVA7JKQW70D64A");
			HITIDs.add("2UHXR24SMEZZZCI7TE0UIP9Y47Z1IN");
			HITIDs.add("2BCU00OQKKA4F8SVZTL2G80EXZGXX9");
			HITIDs.add("2RU9KSSZVXX2NU5H1BHO8GNIX0SM40");
			HITIDs.add("238U6L5OBVCIYHXKB19JP7GU29JZGH");
			HITIDs.add("2CYULF395SW6K612ZUEYXJBYG0KRD6");

			HITIDs.add("2EPH57DZKPFE14G0O4D2FL8IAM43DE");
			HITIDs.add("2X2PEIB9BAWLPCXCXWMX4D3MUQVY1O");
			HITIDs.add("2BVD8XMB3Q39WQBT1KF634EVTS0RGG");
			HITIDs.add("2WT0HFL42J1LVV8YETYMAIGFLGJ1M3");
			HITIDs.add("29D7WGKCCVLL02AQAD8AZQ4CAMVU40");

			HITIDs.add("2C4EC1PC6SK9O98SVQ9ZOHMABOR0OD");
