...
public class Hierarchy {
	...
	public static void run() {
		...
		totalCost = 0;
		exp = 1601;// 1005, 1212, 1302, 1406,1511
		readHierarchyData();
		Interface.readWiki();
		Interface.LocationParentChild = LocationParentChild;

//		ICDRoot = "Non-syndromic diffuse palmoplantar keratodermas";
...
//				}
	...
	public static void readHierarchyData() {
		readICDHierarchy("/Users/Yun/Dropbox/medical/workspace/turk/SampleICDStrcuture2.txt");
